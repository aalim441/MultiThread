...
BOOL CMFCApplication4Dlg::PreTranslateMessage(MSG* pMsg)
{
	...
	if (pMsg->message == WM_KEYDOWN) {
		PostMessage(WM_MY, 100, 200);
		return true;
	}
	return CDialogEx::PreTranslateMessage(pMsg);
}
#include "MFCApplication4Dlg.h"
LRESULT CMFCApplication4Dlg::OnFun(WPARAM wParam, LPARAM lParam)
{
	// 수행할 작업 ( lParam : 넘겨준 값 활용)
	MessageBox(L"I Love MFC!");
	return 0;
}